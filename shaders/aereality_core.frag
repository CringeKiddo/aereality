...
// ---------- UNIFORMS (matches Dart setFloat indices) ----------
uniform vec2 uResolution;          // index 0,1
uniform sampler2D uTexture;        // index via getUniformLocation (should be 0)

uniform float uBrightness;         // index 2
uniform float uSaturation;         // index 3
uniform float uContrast;           // index 4
uniform float uSharpness;          // index 5
uniform float uGamma;              // index 6
uniform float uHue;                // index 7
uniform float uTemperature;        // index 8
uniform float uGlowIntensity;      // index 9
uniform float uLookMix;            // index 10
uniform float uVignette;           // index 11
uniform float uSplitToning;        // index 12
